...
export default function TiposBecaPage() {
      ...
      <div className="mx-auto max-w-7xl space-y-6">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">
                Administre los tipos de becas, descuentos y ayudas aplicables a
                los cursos.
              </p>
            </div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <p className="mt-1 text-sm text-slate-600">
              {estaEditando
                ? "Modifique los datos del tipo de beca seleccionado."
                : "Registre una beca o descuento para usarlo en inscripciones."}
            </p>
            ...
            <form onSubmit={guardarTipoBeca} className="mt-5 space-y-4">
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-slate-500">
                  Coloque 100 para beca completa o exoneración total.
                </p>
              </div>
          ...
          <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm lg:col-span-2">
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              <div>
                ...
                <p className="mt-1 text-sm text-slate-600">
                  Total registrados: {tiposBecaFiltrados.length}
                </p>
              </div>
            </div>
                  ...
                  {loading ? (
                    ...
                    tiposBecaFiltrados.map((item) => (
                      <tr key={item.id} className="border-b hover:bg-slate-50">
                        ...
                        <td className="px-3 py-3 text-slate-600">
                          {Number(item.porcentaje_descuento ?? 0).toFixed(2)}%
                        </td>
